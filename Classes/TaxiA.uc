//-----------------------------------------------------------
// Braindead - Bab's Taxi - Texture by Arramus
//-----------------------------------------------------------
class TaxiA extends BDWheeledvehicle;
...
defaultproperties
{
     ...
     End Object
     Wheels(0)=SVehicleWheel'KF_Vehicles_BD.TaxiA.RRWheel'
     ...
     Begin Object Class=SVehicleWheel Name=LRWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(1)=SVehicleWheel'KF_Vehicles_BD.TaxiA.LRWheel'
     ...
     Begin Object Class=SVehicleWheel Name=RFWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(2)=SVehicleWheel'KF_Vehicles_BD.TaxiA.RFWheel'
     ...
     Begin Object Class=SVehicleWheel Name=LFWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(3)=SVehicleWheel'KF_Vehicles_BD.TaxiA.LFWheel'
     ...
     VehiclePositionString="in a Taxi"
     VehicleNameString="Taxi"
     MaxDesireability=0.400000
     ObjectiveGetOutDist=1500.000000
     GroundSpeed=600.000000
     Mesh=SkeletalMesh'BDVehicles.polcarmk4'
     Skins(0)=Combiner'BDVehicle_T.Vehicle.London_cabFinal'
     Skins(1)=Combiner'BDVehicle_T.Vehicle.interior'
     Skins(2)=Texture'BDVehicle_T.Vehicle.London_cab_decals'
     ...
     End Object
     KParams=KarmaParamsRBFull'KF_Vehicles_BD.TaxiA.KParams0'
