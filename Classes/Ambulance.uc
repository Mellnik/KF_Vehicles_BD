...
// Braindead - Ambulance
//-----------------------------------------------------------
class Ambulance extends BDWheeledvehicle;
...
defaultproperties
{
     ...
     End Object
     Wheels(0)=SVehicleWheel'KF_Vehicles_BD.Ambulance.RRWheel'
     ...
     Begin Object Class=SVehicleWheel Name=LRWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(1)=SVehicleWheel'KF_Vehicles_BD.Ambulance.LRWheel'
     ...
     Begin Object Class=SVehicleWheel Name=RFWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(2)=SVehicleWheel'KF_Vehicles_BD.Ambulance.RFWheel'
     ...
     Begin Object Class=SVehicleWheel Name=LFWheel
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(3)=SVehicleWheel'KF_Vehicles_BD.Ambulance.LFWheel'
     ...
     VehiclePositionString="in an Ambulance"
     VehicleNameString="Ambulance"
     MaxDesireability=0.400000
     ObjectiveGetOutDist=1500.000000
     GroundSpeed=600.000000
     Mesh=SkeletalMesh'BDVehicles.PolVan'
     Skins(0)=Combiner'KillingFloorTextures.Vehicles.LondonAmbulance_cmb'
     Skins(1)=Texture'BDVehicle_T.Vehicle.PolVanInt'
     Skins(2)=Shader'BDVehicle_T.Vehicle.Windscreen_shader'
     Skins(3)=Texture'BDVehicle_T.HUD.INVIS'
     ...
     End Object
     KParams=KarmaParamsRBFull'KF_Vehicles_BD.Ambulance.KParams0'
