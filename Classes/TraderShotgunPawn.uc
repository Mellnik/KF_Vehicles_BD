...
//
//-----------------------------------------------------------
class TraderShotgunPawn extends BDCarWeaponPawn;
...
defaultproperties
{
     GunClass=Class'KF_Vehicles_BD.TraderShotgun'
     CameraBone="CHR_Head"
     ...
     FPCamPos=(X=-120.000000,Y=-16.000000,Z=-15.000000)
     TPCamDistance=0.000000
     TPCamLookat=(X=-90.000000,Z=50.000000)
