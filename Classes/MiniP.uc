//-----------------------------------------------------------
// Braindead - Mini Cooper - Pink Mini skin by Arramus
//-----------------------------------------------------------
class MiniP extends MiniR;
...
defaultproperties
{
     Skins(0)=Combiner'BDVehicle_T.Vehicle.miniPkfinal'
     Skins(2)=Texture'BDVehicle_T.Vehicle.miniinteriorPkUV'
     Skins(3)=Texture'BDVehicle_NP.Sandy1'
}
