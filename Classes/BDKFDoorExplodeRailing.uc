...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter95
         StaticMesh=StaticMesh'BDVehicle_SB.RailingA'
         UseCollision=True
     ...
     End Object
     Emitters(0)=MeshEmitter'KF_Vehicles_BD.BDKFDoorExplodeRailing.MeshEmitter95'

     Begin Object Class=MeshEmitter Name=MeshEmitter96
         StaticMesh=StaticMesh'BDVehicle_SB.RailingB'
         UseCollision=True
         RespawnDeadParticles=False
         SpinParticles=True
         UniformSize=True
         ...
         StartVelocityRange=(X=(Min=-500.000000,Max=500.000000),Y=(Min=-500.000000,Max=500.000000),Z=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=MeshEmitter'KF_Vehicles_BD.BDKFDoorExplodeRailing.MeshEmitter96'
